  ...
  const conversations = [
    {
      ...
      messages: [
        ...
        { id: 2, sender: 'Dr. Sarah Johnson', content: 'Great question! Two-pointer is typically more efficient when you can sort the array or when you\'re looking for pairs. Hash maps are better when you need O(1) lookups and order doesn\'t matter.', timestamp: '10:45 AM', isMe: currentUser?.role === 'faculty', read: true },
    ...
    },
    {
      ...
      messages: [
        ...
        { id: 2, sender: 'Prof. Michael Roberts', content: 'Both approaches work! Recursion is cleaner and easier to understand, but iteration uses less memory. For learning, start with recursion.', timestamp: 'Yesterday 3:35 PM', isMe: currentUser?.role === 'faculty', read: true },
    ...
    },
    {
      ...
      messages: [
        ...
        { id: 2, sender: 'Dr. Sarah Johnson', content: 'Big O describes the upper bound of time complexity. Think of it as the worst-case scenario for your algorithm.', timestamp: '8:10 AM', isMe: currentUser?.role === 'faculty', read: true },
